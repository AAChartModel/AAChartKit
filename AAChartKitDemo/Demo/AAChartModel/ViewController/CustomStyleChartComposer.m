...
@interface CustomStyleChartComposer ()
        ...
        .seriesSet(@[
            AASeriesElement.new
                ...
                .dataSet(@[
                    ...
                    @0.47, @0.52, @0.75, @0.52, @0.56, @0.54, @0.60, @0.46, @0.63, @0.54, @0.51, @0.58, @0.64, @0.60, @0.45, @0.36, @0.67
                ]),
        ]);
}
    ...
    return AAChartModel.new
        ...
        .seriesSet(@[
            AASeriesElement.new
                ...
                .lineWidthSet(@5)
                .colorSet(AAColor.redColor)
                .fillColorSet((id)[AAGradientColor gradientColorWithDirection:AALinearGradientDirectionToRight
                                                                   stopsArray:@[
                ...
                .dataSet(@[@7.0, @6.9, @2.5, @14.5, @18.2,
                    AADataElement.new
                        .dataLabelsSet(AADataLabels.new
                            .enabledSet(true)
                            .useHTMLSet(true)
                            .formatSet([NSString stringWithFormat:@"%@%@%@",
...
+ (AAChartModel *)customAreasplineChartWithColorfulGradientColorZones {
    return AAChartModel.new
        ...
        .legendEnabledSet(false)
        .markerRadiusSet(@0)
        .xAxisLabelsStyleSet(AAStyleColorSizeWeight(AAColor.whiteColor, 12, AAChartFontWeightTypeBold))
        .yAxisLabelsStyleSet(AAStyleColorSizeWeight(AAColor.whiteColor, 13, AAChartFontWeightTypeBold))
        ...
        .seriesSet(@[
            AASeriesElement.new
                ...
                .dataSet(@[@56.5, @33.3, @85.3, @23.9, @29.6, @34.5, @28.2, @26.5, @15.2, @56.5, @33.3,
                    AADataElement.new
                        .markerSet(AAMarker.new
                            .radiusSet(@8)//曲线连接点半径
                            .symbolSet(AAChartSymbolTypeCircle)//曲线点类型："circle", "square", "diamond", "triangle","triangle-down"，默认是"circle"
