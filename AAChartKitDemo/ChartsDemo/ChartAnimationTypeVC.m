...
- (void)setupChartView {
    CGRect frame = CGRectMake(0, 60, self.view.frame.size.width-115, self.view.frame.size.height-60);
...
- (void)configureScatter {
    ...
    self.chartModel.markerRadius = @8;
