...
AAChartKit is Copyright (c) 2017 An An and released as open source under the attached [Apache 2.0 license](https://github.com/AAChartModel/AAChartKit/blob/master/AAChartKit/ChartsDemo/LICENSE).
